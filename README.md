# 📄 arXiv 计算语言学 (cs.CL) 论文库

每天自动抓取 arXiv cs.CL 分类的新论文，经 MinerU 解析后归档为完整可检索的论文笔记。

<!-- 胶囊徽章带：论文数 / 最近更新 / 流水线 / License -->
![Papers](https://img.shields.io/badge/Papers-61-brightgreen?style=flat-square)
![Last commit](https://img.shields.io/github/last-commit/ZhangCurosr/zhangcursor-papers-arxiv-cl-001?style=flat-square)
...
- **内容**：arXiv 计算语言学（Computational Linguistics, cs.CL）分类下每日新增的学术论文。
- **来源**：https://arxiv.org/list/cs.CL/recent
...
# 按标题搜索（示例）
git ls-remote https://github.com/ZhangCurosr/zhangcursor-papers-arxiv-cl-001.git
```
